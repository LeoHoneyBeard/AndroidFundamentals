...
import com.honeybeard.androidfundamentals.activities.main.MainActivity
 ...
 * Use the [MoviewListFragment.newInstance] factory method to
...
class MoviewListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View>(R.id.movie_preview).setOnClickListener{
            (activity as MainActivity).selectMovie()
        }
    }
